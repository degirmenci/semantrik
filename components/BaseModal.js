    ...
    <Transition.Root show={isOpen} as={Fragment}>
      ...
      >
        <div className="flex items-center justify-center min-h-screen py-10 px-4 text-center sm:block sm:p-0">
          ...
          >
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6 dark:bg-black">
              <button
                onClick={() => handleClose()}
                tabIndex={0}
                aria-pressed="false"
